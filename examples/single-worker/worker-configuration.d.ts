/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: dbb0824bf609daf440b71a39e6c33507)
// Runtime types generated with workerd@1.20260124.0 2024-09-23 nodejs_compat
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/index");
		durableNamespaces: "SimplePromptAgent" | "DependentAgent" | "TodoMcpServer" | "ExpenseMcpServer" | "EnvVariableMcpServer" | "SecretMcpServer" | "ImageMcpServer" | "VoiceMcpServer";
	}
	interface Env {
		...
		DEFAULT_NAME: "World";
		SECRET_NUMBER: "42";
		SIMPLE_PROMPT_AGENT: DurableObjectNamespace<import("./src/index").SimplePromptAgent>;
		DEPENDENT_AGENT: DurableObjectNamespace<import("./src/index").DependentAgent>;
		TODO_MCP: DurableObjectNamespace<import("./src/index").TodoMcpServer>;
		EXPENSE_MCP: DurableObjectNamespace<import("./src/index").ExpenseMcpServer>;
		ENV_VARIABLE_MCP: DurableObjectNamespace<import("./src/index").EnvVariableMcpServer>;
		SECRET_MCP: DurableObjectNamespace<import("./src/index").SecretMcpServer>;
		IMAGE_MCP: DurableObjectNamespace<import("./src/index").ImageMcpServer>;
		VOICE_MCP: DurableObjectNamespace<import("./src/index").VoiceMcpServer>;
	}
}
