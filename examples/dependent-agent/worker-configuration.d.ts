/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 76f61f69c0ce4dc7d8b5fb0f38b5b299)
// Runtime types generated with workerd@1.20260124.0 2025-06-01 nodejs_compat
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/index");
		durableNamespaces: "DependentAgent";
	}
	interface Env {
		AI_PROVIDER: string;
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "AI_PROVIDER" | "AI_PROVIDER_API_KEY" | "MODEL_ID">> {}
}
